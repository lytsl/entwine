...
export type GetArktypeType<TColumn extends Column> =
	TColumn["_"]["columnType"] extends
		...
		| "SQLiteTextJson"
		| "SQLiteBlobJson"
		? unknown extends TColumn["_"]["data"]
			? Type<Json>
			: Type<TColumn["_"]["data"]>
		: Type<TColumn["_"]["data"]>;
...
> = TType extends "select"
	? HandleSelectColumn<GetArktypeType<TColumn>, TColumn>
	: TType extends "insert"
		? HandleInsertColumn<GetArktypeType<TColumn>, TColumn>
		: TType extends "update"
			? HandleUpdateColumn<GetArktypeType<TColumn>, TColumn>
