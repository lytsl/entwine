...
import type { IsEnumDefined, IsNever, JsonSchema } from "./utils.ts";

type HasBaseColumn<TColumn> = TColumn extends {
	_: { baseColumn: Column | undefined };
}
		...
		: TColumn["_"]["columnType"] extends "PgBinaryVector"
			...
			: HasBaseColumn<TColumn> extends true
				...
				: IsEnumDefined<TColumn["_"]["enumValues"]> extends true
					? t.TEnum<Assume<TColumn["_"]["enumValues"], string[]>>
					: TColumn["_"]["columnType"] extends "PgGeometry" | "PgPointTuple"
						? t.TTuple<[t.TNumber, t.TNumber]>
						: TColumn["_"]["columnType"] extends "PgLine"
							? t.TTuple<[t.TNumber, t.TNumber, t.TNumber]>
							: TColumn["_"]["data"] extends Date
								? t.TDateTime
								: TColumn["_"]["data"] extends Buffer
									? t.TBuffer
									: TColumn["_"]["dataType"] extends "array"
										? t.TArray<
												GetTypeboxPrimitiveType<
													Assume<TColumn["_"]["data"], any[]>[number]
												>
											>
										: TColumn["_"]["data"] extends Record<string, any>
											? TColumn["_"]["columnType"] extends
												...
												: t.TObject<{
														[K in keyof TColumn["_"]["data"]]: GetTypeboxPrimitiveType<
															TColumn["_"]["data"][K]
														>;
													}>
...
type GetTypeboxPrimitiveType<TData> = TData extends number
	? t.TNumber
...
> = TType extends "select"
	? HandleSelectColumn<GetTypeboxType<TColumn>, TColumn>
	: TType extends "insert"
		? HandleInsertColumn<GetTypeboxType<TColumn>, TColumn>
		: TType extends "update"
			? HandleUpdateColumn<GetTypeboxType<TColumn>, TColumn>
