...
export function NavTeams() {
	...
	const teamsListQuery = useSuspenseQuery({
		queryKey: ["authClient.organization.listTeams", session.organization.id],
		queryFn: () =>
			authClient.organization.listTeams({
				query: { organizationId: session.organization.id },
			}),
	});
	const teams = teamsListQuery.data?.data || [];
