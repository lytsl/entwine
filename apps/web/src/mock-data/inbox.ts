...
import { type IssueStatus, status } from "./status";
...
export const inboxItems: InboxItem[] = [
	...
	},
	{
		...
		description:
			"Add dark mode toggle functionality with automatic system preferences detection",
		status: status[2],
		assignee: users[2],
	...
	},
	{
		...
		description:
			"Improve the navbar responsiveness across all device sizes and orientations",
		status: status[4],
		assignee: users[4],
		priority: priorities[1],
		labels: [labels[1]],
	...
	},
	{
		...
		description:
			"Optimize footer component loading time and reduce bundle size impact",
		status: status[5],
		assignee: users[4],
		priority: priorities[2],
		labels: [labels[3]],
	...
	},
	{
		...
		description:
			"Implement the new card component design with updated styling and interactions",
		status: status[1],
		assignee: users[2],
		priority: priorities[1],
		labels: [labels[2]],
	...
	},
	{
		...
		description:
			"Enhance tooltip component with better positioning and interaction patterns",
		status: status[5],
		assignee: users[2],
		priority: priorities[2],
		labels: [labels[1]],
	...
	},
	{
		...
		description:
			"Fix dropdown menu positioning issues on mobile devices and small screens",
		status: status[2],
		assignee: users[0],
		priority: priorities[0],
		labels: [labels[0]],
	...
	},
	{
		...
		description:
			"Add annotation tools functionality to the PDF viewer component",
		status: status[3],
		assignee: users[1],
		priority: priorities[1],
		labels: [labels[2]],
	...
	},
	{
		...
		description:
			"Restore the previous editor interface design based on user feedback",
		status: status[0],
		assignee: users[5],
		priority: priorities[1],
		labels: [labels[1]],
	...
	},
	{
		...
		description:
			"Revamp button component states and interaction patterns for better UX",
		status: status[5],
		assignee: users[5],
		priority: priorities[2],
		labels: [labels[1]],
		...
		content:
			"🔍 Review completed for PR #808! I did a complete review of your PR",
		type: "comment",
		user: users[5],
		timestamp: "5w",
		read: true,
	...
	},
	{
		...
		description:
			"Fix issues with audio file upload functionality on mobile devices",
		status: status[1],
		assignee: users[4],
		priority: priorities[0],
		labels: [labels[0]],
	...
	},
	{
		...
		description:
			"Add transcription preview functionality to the media player component",
		status: status[4],
		assignee: users[6],
		priority: priorities[1],
		labels: [labels[2]],
