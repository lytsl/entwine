...
function IssueDragPreview({
  ...
  console.log("IssueDragPreview", {
    [`new Date(issue.createdAt)`]: new Date(issue.createdAt),
  ...
  return (
    <div className="w-full overflow-hidden rounded-md border border-border/50 bg-background p-3">
      <div className="mb-2 flex items-center justify-between">
        ...
        <StatusSelector status={issueStatus} issueId={issue.id} />
      </div>
